...
public class SolicitudEliminacionDTO {
    ...
    public SolicitudEliminacionDTO(String texto, String hecho, LocalDateTime fechaSolicitud, EstadoSolicitud estado) {
        this.texto = texto;
        this.hecho = hecho;
    ...
    public static SolicitudEliminacionDTO fromSolicitudEliminacion(SolicitudEliminacion solicitud){
        return new SolicitudEliminacionDTO(solicitud.getTexto(), solicitud.getHecho(), solicitud.getFechaSolicitud(), solicitud.getEstado());
    }
