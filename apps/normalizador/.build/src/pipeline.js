...
export class NormalizadorPipeline {
     ...
     */
    estaHabilitado(normalizador) {
        const nombre = normalizador.nombre;
        if (nombre === 'TextoNormalizador')
            return this.config.normalizarTexto;
        if (nombre === 'CategoriaNormalizador')
            return this.config.normalizarCategorias;
        if (nombre === 'FechaNormalizador')
            return this.config.normalizarFechas;
        if (nombre === 'CoordenadasNormalizador')
            return this.config.normalizarCoordenadas;
        if (nombre === 'EtiquetasNormalizador')
            return this.config.normalizarEtiquetas;
